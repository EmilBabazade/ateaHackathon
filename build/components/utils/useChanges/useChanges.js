...
export function useChanges(unchanged) {
    ...
    const change = React.useCallback((changes) => {
        setChanges(prevState => (Object.assign(Object.assign({}, prevState), changes)));
    }, [setChanges]);
    ...
    const model = React.useMemo(() => {
        return Object.assign(Object.assign({}, (unchanged !== null && unchanged !== void 0 ? unchanged : {})), changes);
    }, [unchanged, changes]);
