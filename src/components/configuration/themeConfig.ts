...
import {createTheme, PaletteColorOptions, PaletteMode, responsiveFontSizes} from "@mui/material";


/*
    overrides for introducing custom colour values
*/
declare module '@mui/material/styles' {
    interface CustomPalette {
        surface: PaletteColorOptions;
        accentText: PaletteColorOptions;
        accentSurface: PaletteColorOptions;
        accentBackground: PaletteColorOptions;
...
const palleteLight: PaletteOptions = {
    mode: "light",
